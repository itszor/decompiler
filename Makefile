...
OCAMLSRC := elfreader.ml dwarfreader.ml dwarfprint.ml line.ml \
	    ...
	    ranlist.ml boolset.ml getoption.ml code.ml block.ml irtypes.ml \
	    ir.ml ctype.ml function.ml binary_info.ml insn_to_ir.ml plt.ml \
	    dfs.ml dominator.ml phi.ml typedb.ml minipool.ml sptracking.ml \
	    decompiler.ml
