ocamlfind ocamlmktop -syntax camlp4o -package camlp4.macro,num,unix,bitstring,bitstring.syntax \
  ...
  boolset.cmo getoption.cmo code.cmo block.cmo ctype.cmo irtypes.cmo ir.cmo \
  ctype.cmo function.cmo builtin.cmo binary_info.cmo insn_to_ir.cmo plt.cmo \
  dfs.cmo dominator.cmo phi.cmo typedb.cmo minipool.cmo sptracking.cmo \
  decompiler.cmo -o decomp_top
